          ...
          <div className="relative group/package_banner rounded-3xl max-h-[25rem] max-sm:max-h-60 overflow-hidden">
            ...
            <div className="absolute space-y-1 flex flex-col justify-end p-8 inset-0 fade-gradient-bottom z-20 opacity-100">
              ...
              <div className="flex items-center justify-between select-none">
                <span className="text-sm text-gray-200 font-primary">
                  {data.data.short_description}
                </span>

                {/* <span className="flex items-center gap-0.5 font-primary">
                  <FaStar className="text-yellow-300" size={12} />
                  <span className="font-medium text-xs ml-1.5 text-white">
                    4.72
                  </span>
                  <span className="inline-block size-1.5 rounded-full bg-white mx-1.5"></span>
                  <Link href={"#"} className="text-xs text-gray-200 underline">
                    60 Reviews
                  </Link>
                </span> */}
              </div>
