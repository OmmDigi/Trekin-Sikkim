...
export default function BlogComments() {
  return (
    // <div className="font-primary space-y-5">
    ...
    //   <h2 className="font-semibold">Comments (20)</h2>
    //   <ul>
    //     <li>
    //       <div className="flex items-center gap-3">
    //         <div className="size-8 bg-gray-200 rounded-full"></div>
    //         <span className="font-semibold text-sm">John Doe</span>
    //         <span className="text-gray-500 text-xs">17 Mar, 2025</span>
    //       </div>

    //       <p className="ml-11 text-sm">
    //         Lorem ipsum dolor sit amet consectetur adipisicing elit. At sequi
    //         culpa maxime dolores officiis vitae hic, et sed natus doloremque
    //         placeat, dicta consequuntur? Modi voluptates ullam, aspernatur illo
    //         aut eligendi!
    //       </p>
    //     </li>
    //   </ul>
    // </div>
    <section className="bg-white max-sm:py-8 antialiased font-primary">
      <div>
